...
function App() {
  const handleAddSock = async (sock) => {
    try {
      ...
      if (!response.ok) {
        throw new Error(`Failed to add sock, status: ${response.status}`);
      }
 
      const updatedData = [...data, sock];
      setData(updatedData);
    } catch (error) {
            ...
            <div className="row">
              ...
              <div className="card-container" style={{
                ...
                <Routes>
                  ...
                  <Route path="/form" element={<Form handleAddSock={handleAddSock} />} />
                </Routes>
              </div>
