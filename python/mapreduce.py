...
It's really similar to what we did in lab this week. In this sample, the goal 
is to print out the word count per word in the input text.
...
if __name__ == '__main__':
    try:
        main()
        print("Hurray! PySpark is working properly! :)")
    except Exception as e:
        print(e)
        print("Hmmm, PySpark does not seem to be working properly.")
        print("Please ensure that you have Java installed (described in the handout), and if problems persist, feel free to ask on Ed for help!")